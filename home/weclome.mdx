---
title: 首页欢迎ip
description: 让你公告栏显示欢迎信息，访客ip; 来自石头大佬：https://blog.kouseki.cn/posts/da2a.html
---
## 新建js文件
新建js文件，名字随意

请前往腾讯地图开放平台自行申请apikey，类型选择webserverapi，然后把你的网站域名设为放行域名（建议把本地开发端口也设为放行域名方便调试）
...
function showWelcome() {
    ...
    let dist = getDistance(113.75, 23.04, ipLocation.result.location.lng, ipLocation.result.location.lat); //这里记得换成自己的经纬度
